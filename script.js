...
function calculateFinances() {
    ...
    // 计算每年的财务情况并生成表格
    var table = "<table><tr><th>年份</th><th>年初存款总额</th><th>年末存款总额</th><th>年利息收入</th><th>年收入</th><th>社保</th><th>公积金</th><th>税款</th></tr>";
    ...
    for (var i = 0; i < retirementYears; i++) {
        ...
        table += "<tr><td>" + (year + i) + "</td><td>" + startOfYearSavings.toFixed(2) + "</td><td>" + futureSavings.toFixed(2) + "</td><td>" + interestEarned.toFixed(2) + "</td><td>" + annualIncomeDisplay.toFixed(2) + "</td><td>" + socialSecurityDisplay.toFixed(2) + "</td><td>" + housingFundDisplay.toFixed(2) + "</td><td>" + taxDisplay.toFixed(2) + "</td></tr>";
    }
    table += "</table>";
